...
import { drawPilotPlate, drawFramePlate, setCtx } from "../../src/core/index";
import { fontFor } from "./fonts";

/* @param kind "pilot" | "frame"
   @param dep  다시 그려야 할 이유(도장 변경·테마 변경)를 문자열로 넘긴다 */
export default function Plate({ kind, item, size = 62, dep = "" }) {
  const picture = useMemo(() => {
    ...
    else drawFramePlate(g, item, size);
